...
import { applyJob, getJobApplicants,updateApplicationStatus } from "../controller/applicationController.js";
...
router.get("/", (req, res) => {
  ...
  router.patch("/api/v1/applications/:applicationId/status", verifyToken, verifyEmployer, updateApplicationStatus);


  router.post("/api/v1/subscriptions", verifyToken, verifyEmployer, buySubscription);
